...
class SettingsController extends Controller
{
     ...
     * @param string $cas_import_ad_deactivate_filter
     ...
     * @param string $cas_import_map_groups_exclude_dn_filter
    ...
    public function saveSettings($cas_server_version, $cas_server_hostname, $cas_server_port, $cas_server_path, $cas_protected_groups, $cas_default_group, $cas_groups_letter_filter, $cas_groups_create_default_for_user_prefix,
                                    ...
                                    $cas_import_ad_protocol, $cas_import_ad_host, $cas_import_ad_port, $cas_import_ad_user, $cas_import_ad_domain, $cas_import_ad_password, $cas_import_ad_base_dn, $cas_import_ad_sync_filter, $cas_import_ad_deactivate_filter, $cas_import_ad_sync_pagesize,
                                    $cas_import_map_uid, $cas_import_map_displayname, $cas_import_map_email, $cas_import_map_groups, $cas_import_map_groups_description, $cas_import_map_groups_exclude_dn_filter, $cas_import_map_quota, $cas_import_map_enabled, $cas_import_map_enabled_and_bitwise, $cas_import_map_dn, $cas_import_map_dn_filter,
                                    ...
                                    $cas_groups_create_default_for_user = NULL, $cas_shares_protected = NULL)
    {
        ...
        try {
            ...
            $this->config->setAppValue($this->appName, 'cas_import_ad_deactivate_filter', htmlspecialchars_decode($cas_import_ad_deactivate_filter));
            ...
            $this->config->setAppValue($this->appName, 'cas_import_map_groups_exclude_dn_filter', $cas_import_map_groups_exclude_dn_filter);
