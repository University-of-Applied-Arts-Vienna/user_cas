...
* Add setting to allow json-decode for mapped group attribute (see: Issue [#51](https://github.com/example/user_cas/issues/51))
* Add mapping for user-id attribute (see: Issue [#70](https://github.com/example/user_cas/issues/70))
* Add setting for adding default group, based on the user’s name and an optional prefix (see: Issue [75](https://github.com/example/user_cas/issues/75))
* Add setting to protect public share links with CAS (see: Issue [93](https://github.com/example/user_cas/issues/93))
* Possibly fixes WEBDAV problems (see: Issues [57](https://github.com/example/user_cas/issues/57) and [94](https://github.com/example/user_cas/issues/94))
...
* Fixes Nextcloud login-flow bug (see Issue [#69](https://github.com/example/user_cas/issues/69)) - thanks to [@pingou2712](https://github.com/pingou2712>)
...
* Adds option to keep CAS-ticket-ids in URL (see [Issue #17](https://github.com/example/user_cas/issues/17))
...
Version 1.4.9
-------------
* Hotfixes the autocreate bug, mentioned in Issue [#13](https://github.com/example/user_cas/issues/13).
